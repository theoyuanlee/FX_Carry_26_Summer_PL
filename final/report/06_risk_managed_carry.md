...
**One coverage caveat first, because it bears on the Crisis bucket specifically.** The regime series
starts **2008-06-11** — the composite needs a trailing percentile window before it can label
anything — so the classification covers **4,702 of the sample's 5,001 days** and cannot see the
pre-crisis era or the first nine months of GFC 2008. The regime *conditional* results below are
therefore about 2008-06 onward. The allocation results are not affected (an unlabelled day is
treated as fully invested), but a Crisis bucket whose defining episode is half outside the series
that defines it is worth knowing about before reading its Sharpe.
