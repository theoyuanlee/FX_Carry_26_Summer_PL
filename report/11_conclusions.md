...
*Source: `final/evidence/strategy_menu.csv`, `final/evidence/strategy_menu_by_window.csv`,
`final/evidence/strategy_menu_matched_risk.csv`, built by `final/menu.py`.*
