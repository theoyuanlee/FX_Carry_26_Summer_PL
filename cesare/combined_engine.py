...
saying so is part of the deliverable.
    ...
    python cesare/combined_engine.py        # standalone table + both ladders

Outputs (all to `cesare/outputs/`):
...
ARJUN_SERIES = REPO_ROOT / "arjun" / "outputs" / "duration_hedge_series.csv"
VIDHI_MONTHLY = REPO_ROOT / "vidhi" / "outputs" / "adaptive_strategy_returns_monthly.csv"
THEO_PANEL = REPO_ROOT / "theo" / "data" / "processed" / "fx_option_signal_panel.parquet"
